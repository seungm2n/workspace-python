...
'''
# 선언
a = {'name': 'SeungMin', 'phone': '01023439874', 'birth': '990124'}
b = {0: 'Hello SeungMin!'}
c = {'arr': [1, 2, 3, 4]}
...
print('a : ', a.get('phone1'))     # 존재X => None 처리
print('b : ', b[0])
print('b : ', b.get(0))
print('c : ', c['arr'])
print('c : ', c['arr'][3])
...
# 모든 키(key)를 하나씩 확인 할 때는 keys()메서드를 사용함
data = {}
data['apple'] = "사과"
data['banana'] = "바나나"
data['carrot'] = "당근"
...
'''
  ...
  - 특정한 데이터가 등장한 적이 있는지 체크할때 효과적으로 사용됨
  - 데이터를 삽입할 때는 add() 메서드를 사용함
'''
