...
'''
    ...
    - Model777 모델로 10 epoch을 반복 학습시킨 결과는 학습 정확도 : 0.85, 검증 정확도 : 0.83, 테스트 정확도 : 0.76으로 나왔습니다.
...
# case 1
print(f"{model_name} 모델로 {epoch}을 반복 학습시킨 결과는 학습 정확도 : {train_accuracy}, 검증 정확도 : {val_accuracy}, 테스트 정확도 : {test_accuracy}으로 나왔습니다.")

# case 2
print("{} 모델로 {}을 반복 학습시킨 결과는 학습 정확도 : {}, 검증 정확도 : {}, 테스트 정확도 : {}으로 나왔습니다.".format(
    "Model777", 10, 0.85, 0.83, 0.76))

# case 3
print("%s 모델로 %d을 반복 학습시킨 결과는 학습 정확도 : %.2f, 검증 정확도 : %.2f, 테스트 정확도 : %.2f으로 나왔습니다." %
      ("Model777", 10, 0.85, 0.83, 0.76))


'''
    어떤 학급의 학생 5명의 키에 대한 정보가 주어집니다.
    이들 리스트로 만들고 heights라는 변수에 저장하시오.
...
'''
    전학을 갔던 친구보다 더 키가 큰 순신이라는 친구가 전학을 왔습니다.
    이 친구의 키는 200cm 입니다.
...
'''
    5명의 학생들의 키는 있지만, 누구의 키인지 알 수 없습니다.
...
'''
seungm2n_man = "911209-1234567"
seungm2n_woman = "900102-2597642"
seungm2n_man2 = "881209-1223657"
seungm2n_woman2 = "990102-2753542"

print(seungm2n_man[:-6] + '*' * 6)
print(seungm2n_woman[:-6] + '*' * 6)
print(seungm2n_man2[:-6] + '*' * 6)
print(seungm2n_woman2[:-6] + '*' * 6)

seungm2n = [1, ['a', 2], 3.14, "누구세요?"]
print(seungm2n)

# seungm2n index2부터 끝까지 잘라내기를 하시오.
print(seungm2n[2:])
print(seungm2n[-1])

# seungm2n 원소 중 'a' 를 출력해 보시오.
print(seungm2n[1][0])
